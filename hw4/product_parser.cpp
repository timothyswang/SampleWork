...
Product* ProductBookParser::makeProduct()
{
    ...
    return new Book(prodName_, prodName_, price_, qty_, isbn_, author_);
...
Product* ProductClothingParser::makeProduct()
{
    ...
    return new Clothing(prodName_, prodName_, price_, qty_, size_, brand_);
...
Product* ProductMovieParser::makeProduct()
{
    ...
    return new Movie(prodName_, prodName_, price_, qty_, genre_, rating_);
